...
| `tools` | the EXACT tool surface. Codex restricts the agent to this list — a tool not listed cannot be called |
...
That invariant is checkable. `validate_agents.py` (shipped to `.codex/hooks/`)
