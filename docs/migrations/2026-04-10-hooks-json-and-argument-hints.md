...
**argument-hint** added to skill frontmatter. Slash commands now show inline hints in Codex about what arguments they accept.
...
2. Compare to your vault's `.codex/hooks.json` hooks section
...
cp meeting-todos/SKILL.md ~/.agents/skills/meeting-todos/SKILL.md
```
