...
## Why
Vaults decay into ambiguity. The same type of content ends up in multiple folders because there was never a written rule for where it belongs. RESOLVER.md files make the decision tree explicit and permanent — Codex reads it before creating any file in that folder.
