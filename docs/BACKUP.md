...
```bash
bash ~/plugins/codex-brain-starter/scripts/vault-backup.sh setup
```

(Windows: `pwsh ~/plugins/codex-brain-starter/scripts/vault-backup.ps1 setup`)
...
```bash
bash ~/plugins/codex-brain-starter/scripts/vault-backup.sh setup --encrypt
```
...
```bash
bash ~/plugins/codex-brain-starter/scripts/vault-backup.sh verify
```
...
```bash
bash ~/plugins/codex-brain-starter/scripts/vault-backup.sh status
```
...
- **`vault-backup.sh schedule`** is the reachable repair path for that, and the
  ...
  ```bash
  bash ~/plugins/codex-brain-starter/scripts/vault-backup.sh schedule
  ```
...
```bash
python3 ~/plugins/codex-brain-starter/scripts/check-vault-backup.py "<vault-path>"
```
