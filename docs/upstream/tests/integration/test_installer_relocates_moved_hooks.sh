...
{ "hooks": { "UserPromptSubmit": [ { "hooks": [
  { "type": "command", "command": "python3 ~/plugins/codex-brain-starter/hooks/session-start-context.py 2>/dev/null || echo '{\"continue\":true,\"suppressOutput\":true}'", "once": true },
  { "type": "command", "command": "python3 ~/plugins/codex-brain-starter/hooks/inject-instinct-context.py 2>/dev/null || echo '{\"continue\":true,\"suppressOutput\":true}'", "once": true },
