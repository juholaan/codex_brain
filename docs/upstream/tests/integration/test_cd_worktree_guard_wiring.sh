...
#      machines that had hand-wired it into ~/.codex/settings.json.
#
...
skill = "python3 ~/plugins/codex-brain-starter/hooks/check-cd-outside-worktree.py"
hand = "/usr/bin/python3 /home/u/.codex/hooks/check-cd-outside-worktree.py"
...
assert_eq "cd to a sibling worktree ALLOWS" \
  "$(run "$wt" "cd $main/.codex/worktrees/other")" 0
