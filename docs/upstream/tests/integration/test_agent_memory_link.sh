...
# memory Codex writes to its project dir actually lands IN THE VAULT.
...
export CLAUDE_HOME="$WORK/.claude"   # redirect ~/.codex/projects for the test
...
# THE NEGATIVE CONTROL: write where Codex would, assert it reaches the vault.
