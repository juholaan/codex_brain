...
> "`$second-brain-mapping` has four phases. Phases 1 (metadata) and 4 (insights) are FREE — zero LLM. You get Codex's context layer on day one.
>
...
- `~/.agents/skills/graphify/SKILL.md` — the graphify skill's full instructions
- `~/.agents/skills/graphify/OPTIMIZATIONS.md` — the wrapper pipeline details (token savings of 80–92% with it vs without)
- `~/.agents/skills/second-brain-mapping/SKILL.md` — the orchestrator that gates graphify behind a confirm prompt
