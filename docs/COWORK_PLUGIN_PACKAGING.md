...
Any skill in this repo can be extracted and published as a standalone Codex / Cowork marketplace plugin. This doc covers the format, the de-personalization checklist, and how to submit.
...
├── .codex/config.toml              ← required: {} if no MCP servers needed
├── skills/
│   └── skill-name/
...
{
  "name": "my-plugin",
  "description": "One sentence: what it does and when Codex should use it.",
  "author": {
    "name": "Your Name",
