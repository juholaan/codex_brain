...
Wired into ~/.codex/settings.json hooks.PostToolUse with matcher "Agent".
"""
...
def main() -> None:
    ...
    warn(
        ...
        f"Task was: {description!r}. Gate 5 of agent-briefing (AGENTS.md): "
        "validate subagent returns BEFORE aggregating. Issues:"
    )
    for i, msg in enumerate(issues, 1):
        warn(f"  [{i}] {msg}")
    warn(
        "Per AGENTS.md (see canonical rule) Candidate 1 + AGENTS.md "
