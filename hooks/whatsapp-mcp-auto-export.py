...
When Codex calls a WhatsApp MCP read tool (list_messages, list_chats,
...
Codified 2026-05-05 alongside AGENTS.md rule "WhatsApp pulled via MCP
...
# Sends are included so Codex-authored replies land in the vault on the
