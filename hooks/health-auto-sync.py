...
Fires at the start of every Codex session. Checks the freshness of
...
Output is JSON to stdout per Codex hook spec:
...
the user (and Codex) can see what just happened. If nothing was stale,
the hook is silent.
