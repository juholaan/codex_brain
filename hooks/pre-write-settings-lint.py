#!/usr/bin/env python3
"""
PreToolUse blocker for Write/Edit on Codex config files.

Fires on Write|Edit. If tool_input.file_path is a Codex config file
...
with stderr explanation. Codex treats exit 2 as deny.
...
def main() -> int:
    ...
    if result.returncode == 2:
        print(
            ...
            "This write would silently corrupt your Codex config. "
