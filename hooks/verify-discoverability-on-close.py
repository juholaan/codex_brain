...
via the Codex settings `env` block). MYC-1270 (cross-repo de-dup: one canonical
...
def _norm(p: str | Path) -> str:
    ...
    `~/.codex/projects/.../memory` on some surfaces) so a transcript that wrote
...
def main() -> int:
    ...
    msg = (
        ...
        f"      For SKILL.md: ln -sfn <skill-dir> ~/.agents/skills/<name>\n"
