...
Wired via PreToolUse matcher: "Agent" in ~/.codex/settings.json or
...
# ~/.codex/projects, so it already works for a Read of either runbook in ANY
...
def runbook_read_recently(transcript_path: Path | None, runbook_filename: str) -> bool:
    ...
    for line in reversed(lines):
        try:
            ...
            continue
        # tool_use entries vary in shape across Codex versions
