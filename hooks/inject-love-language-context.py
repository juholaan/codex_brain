...
Index cache: ~/.codex/.love-language-index.json. Rebuilt when the newest
...
Wire into settings.json under hooks.UserPromptSubmit:
    {
      "type": "command",
      "command": "python3 ${PLUGIN_ROOT}/hooks/inject-love-language-context.py"
    }
...
INDEX_PATH = os.path.expanduser("~/.codex/.love-language-index.json")
