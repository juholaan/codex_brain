...
Ledger: ~/.codex/instinct/observations.jsonl  (one JSON object per line)
...
LEDGER = Path(os.environ.get(
    ...
    str(Path.home() / ".codex" / "instinct" / "observations.jsonl"),
))
...
def _self_test() -> int:
    ...
    payloads = [
        ...
        {"tool_name": "Write", "tool_input": {"file_path": "/x/.codex/admin.env"}},
