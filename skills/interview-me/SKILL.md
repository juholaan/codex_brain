---
name: "interview-me"
description: "Use when an ask is underspecified (\"build me X\" without who it's for, why now, or what success looks like), when a request is conventional rather than specific (\"a dashboard\", \"make it faster\" with no number), when Codex catches itself silently filling in ambiguous requirements before any plan, spec, or code exists, or when the user says \"interview me\", \"grill me\", \"are we sure?\", or \"stress-test my thinking\". Needs a live user; not for CI, scheduled runs, or autonomous loops."
---
