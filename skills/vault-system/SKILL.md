...
| Vault self-check (AGENTS.md / Meta folder / skills / hooks / MCPs / journal index) | `diagnose` |
...
- Extract recurring patterns into a AGENTS.md rule / rules file → codify manually into a new rule file
