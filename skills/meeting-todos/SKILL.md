...
2. **If none of those exist**, read the user's vault `AGENTS.md` for a vault-map / to-do location hint. If the hint resolves to an existing file, use it and proceed to Step 1.
