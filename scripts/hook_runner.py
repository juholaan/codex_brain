#!/usr/bin/env python3
"""hook_runner.py — portable failure-masking wrapper for Codex hooks.
...
On native Windows, Codex executes hook commands under PowerShell 5.1,
...
def main(argv: list[str]) -> int:
    ...
    if proc.returncode == 0:
        # Forward exactly — an empty stdout is a valid no-op for Codex.
        if proc.stdout:
