...
The melt
--------
The Codex Desktop app has a per-session "worktree" checkbox. On a CODE repo a
...
def _print_human(token: str, count: int, vault: Path) -> None:
    if token == "OK_NOT_VAULT":
        ...
        print("WARN  {} git worktree checkout(s) live INSIDE the vault at {}/.codex/worktrees/."
              .format(count, vault))
