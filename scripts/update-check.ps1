...
#   powershell -File "$env:USERPROFILE\plugins\codex-brain-starter\scripts\update-check.ps1" -Force

param([switch]$Force)

$RepoDir   = "$env:USERPROFILE\plugins\codex-brain-starter"
$CheckFile = "$env:USERPROFILE\.codex\.ai-brain-starter-last-check"
