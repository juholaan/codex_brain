...
V1="$TMP/$ICLOUD/MyBrain"; mkdir -p "$V1"; : > "$V1/AGENTS.md"
...
want_contains "registry: tells Codex not to dump a menu"     "Do NOT make them choose" "$ctx"
...
V2="$TMP/$ICLOUD/GitBrain"; mkdir -p "$V2"; : > "$V2/AGENTS.md"; git -C "$V2" init -q
...
V3OLD="$TMP/$ICLOUD/MovedBrain"; mkdir -p "$V3OLD"; : > "$V3OLD/AGENTS.md"
...
V4="$TMP/$ICLOUD/SidecarBrain"; mkdir -p "$V4"; : > "$V4/AGENTS.md"
...
V5="$TMP/plainlocal/Brain"; mkdir -p "$V5"; : > "$V5/AGENTS.md"; git -C "$V5" init -q
