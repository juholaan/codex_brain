"""NVIDIA-vs-Codex comparison harness.

Before flipping any pipeline from Codex to a Tier-2 model (NVIDIA / Llama /
...
API:
  ...
  claude_fn(input) -> str | dict | list  -- the existing Codex pipeline
