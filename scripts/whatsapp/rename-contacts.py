...
Requirements:
  ...
  - The app you run this from (Codex, Terminal, iTerm, ...) needs permission to
...
def host_app() -> str:
    ...
    enable "Terminal" when they ran this from Codex points them at a row that is
    not in their list.
    """
    bundle = os.environ.get("__CFBundleIdentifier", "")
    known = {
        "com.anthropic.claudefordesktop": "Codex",
