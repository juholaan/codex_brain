...
You are writing to a Codex-facing doc (memory file, hookify rule, vault rule, or AGENTS.md).
...
Scope: memory files, hookify rules, vault rule files, and AGENTS.md. Human-facing docs (READMEs, CHANGELOGs, journal entries, meeting notes) are not affected.
