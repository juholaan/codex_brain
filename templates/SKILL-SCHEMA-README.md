...
2. `CLAUDE_ACTIVE_SKILL` env var. Skill name (slug). Resolved against `skills/<name>/SKILL.md` first, then `~/.agents/skills/<name>/SKILL.md`, then `~/plugins/codex-brain-starter/skills/<name>/SKILL.md`.
...
These four fields lift skills from "prose Codex reads" to "structured executable object the harness can reason about."
